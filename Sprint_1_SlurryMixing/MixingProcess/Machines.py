...
class MixingMachine(Machine):
    ...
    def _mix_component(self, component, step_percent, pause_sec):
        ...
        for _ in range(steps):
            ...
            if now - last_saved_time >= 0.1: ##Change for testing 
                ...
                filename = f"C:/Users/13min/factory-ui/Sprint_1_SlurryMixing/MixingProcess/results/result_at_{round(self.total_time)}s.json"
    ...
    def _save_final_results(self):
        ...
        filename = f"C:/Users/13min/factory-ui/Sprint_1_SlurryMixing/MixingProcess/results/final_results_{self.id}.json"
