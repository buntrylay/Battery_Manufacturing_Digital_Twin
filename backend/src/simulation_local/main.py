...
anode_mixing_machine = MixingMachine("TK_Mix_Anode", "Anode", anode_slurry, user_input_anode, connection_string="HostName=SW-DEV-a633d6e2-a3f2-11ef-a7f3-000d3a8201a5.azure-devices.net;DeviceId=ACTestSwin;SharedAccessKey=AIZ4O/jiLzaXY4v5GMr5VSPfA26TF4o14iNApHMv3VA=")
cathode_mixing_machine = MixingMachine("TK_Mix_Cathode", "Cathode", cathode_slurry, user_input_cathode, connection_string="HostName=SW-DEV-a633d6e2-a3f2-11ef-a7f3-000d3a8201a5.azure-devices.net;DeviceId=ACTestSwin;SharedAccessKey=AIZ4O/jiLzaXY4v5GMr5VSPfA26TF4o14iNApHMv3VA=")
