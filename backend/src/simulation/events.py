...
class EventBus:
    ...
    def subscribe(self, event_type: MachineEventType, callback: Callable[[MachineEvent], None]):
        """Subscribe to events of a specific type."""
        if event_type not in self._listeners:
            self._listeners[event_type] = []
        self._listeners[event_type].append(callback)
    
    def unsubscribe(self, event_type: MachineEventType, callback: Callable[[MachineEvent], None]):
